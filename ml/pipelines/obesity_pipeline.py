...
print("Obesity pipeline started...")

BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "data")

df = pd.read_csv(os.path.join(BASE_DIR, "obesity.csv"))
...
with open(os.path.join(MODELS_DIR, "obesity_classifier.pkl"), "wb") as f:
    pickle.dump(classifier_pipeline, f)

with open(os.path.join(MODELS_DIR, "obesity_regressor.pkl"), "wb") as f:
