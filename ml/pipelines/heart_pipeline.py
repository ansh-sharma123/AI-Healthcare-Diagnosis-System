...
print("Heart disease pipeline started...")
...
pickle.dump(classifier_pipeline, open(os.path.join(MODELS_DIR, "heart_classifier.pkl"), "wb"))
pickle.dump(regressor_pipeline, open(os.path.join(MODELS_DIR, "heart_regressor.pkl"), "wb"))
