...
print("Kidney disease pipeline started...")

BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "data")

df = pd.read_csv(os.path.join(BASE_DIR, "kidney.csv"))
...
with open(os.path.join(MODELS_DIR, "kidney_classifier.pkl"), "wb") as f:
    pickle.dump(classifier_pipeline, f)

with open(os.path.join(MODELS_DIR, "kidney_regressor.pkl"), "wb") as f:
